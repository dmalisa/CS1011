 ...
 * Course CS1011-051
 * Fall 2020-2021
 * House purpose: to compare two generated house costs
 *
 * @author Malisa 2
 * @version created on 20/10/2020 at 01:28
 */
...
public class House {
    ...
    private static BuildingCostEstimator getBuildingCostEstimator(Scanner in) {
        ...
        System.out.println("This program will help you estimate the "
                + "cost of building a house. You will enter details for two houses " +
                "and the costs will be compared.");
